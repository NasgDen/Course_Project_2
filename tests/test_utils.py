from src.utils import convert_object_to_dict, filter_vacancies, get_vacancies_by_salary, sort_vacancies, get_top_vacancies, print_vacancies
...
def test_print_vacancies(list_vacation_sort, capsys):
    ...
    assert message.out.strip() == """Наименование :Python Developer
